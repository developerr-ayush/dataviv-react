      ...
      <div className="container mb-5 text-center" data-aos="fade-up">
        <div className="row align-items-center">
          <div className="col-12 pb-5">
            <h2 className="text-white">Delivered Excellence.</h2>
          </div>
          <div className="col-lg-3 col-md-6">
            <h3><span data-purecounter-start="0" data-purecounter-end="30" className="purecounter">0</span>+</h3>
            <div className="line"></div>
            <h4 className="primary-text-color">MNCs</h4>
          </div>
          <div className="col-lg-3 col-md-6">
            <h3><span data-purecounter-start="0" data-purecounter-end="70" className="purecounter">0</span>+</h3>
            <div className="line"></div>
            <h4 className="primary-text-color">Rising Startups</h4>
          </div>
          <div className="col-lg-3 col-md-6">
            <h3><span data-purecounter-start="0" data-purecounter-end="100" className="purecounter">0</span>+</h3>
            <div className="line"></div>
            <h4 className="primary-text-color">Customers</h4>
          </div>
          <div className="col-lg-3 col-md-6">
            <h3><span data-purecounter-start="0" data-purecounter-end="200" className="purecounter">0</span>+</h3>
            <div className="line"></div>
            <h4 className="primary-text-color">Technologies</h4>
          </div>
        </div>
      </div>
    </div>
