        ...
        <div class="scene">
            ...
            <div class="container text-white">
                <div class="row  align-items-center overflow-hidden">
                    <div class="col-lg-6 my-5" data-aos="fade-right">
                        <div class="img">
    
                            <img src={owner} class="test1" alt="owner"/>
                        </div>
                    </div>
                    <div class="col-lg-6 my-5" data-aos="fade-left">
                        <h2>
                            Chief Executive Officier Profile
                        </h2>
                        <h5 class="primary-text-color mt-3">Vedant Ahluwalia</h5>
                        ...
                        <a href="https://www.linkedin.com/in/vedant-ahluwalia-bb258262/" class="btn btn-primary custom-button-2 ms-0 px-3 py-2">
                            <span>
                ...
                <div class="row align-items-center flex-wrap-reverse overflow-hidden">
                    <div class="col-lg-6 my-5" data-aos="fade-right">
                        <h2>
                    ...
                    <div class="col-lg-6 my-5" data-aos="fade-left">
                        <div class="image">
                            <img src={comingSoon} alt="tech" class="shadow"/>
